    ...
    <GridToolbarContainer>
      ...
      >
        <Box sx={{ display: 'flex', flexDirection: 'column' }}>
          <Typography variant="h5">Empoderamiento Económico y Educación</Typography>
          <Typography variant="body2">
            Apoyo financiero y oportunidades económicos/educacional
          </Typography>
        </Box>
...
export default function FinancialGrid({ onGridChange, values }: GridProps) {
  ...
  useEffect(() => {
    onGridChange('financial', JSON.stringify(rows));
  }, [rows, onGridChange]);
