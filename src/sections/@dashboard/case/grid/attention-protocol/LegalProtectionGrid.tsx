    ...
    <GridToolbarContainer>
      ...
      >
        <Box sx={{ display: 'flex', flexDirection: 'column' }}>
          <Typography variant="h5">Apoyo/Protección Legal</Typography>
        </Box>
...
export default function LegalProtectionGrid({ onGridChange, values }: GridProps) {
  ...
  useEffect(() => {
    onGridChange('legalProtection', JSON.stringify(rows));
  }, [rows, onGridChange]);
