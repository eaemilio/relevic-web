    ...
    <GridToolbarContainer>
      ...
      >
        <Box sx={{ display: 'flex', flexDirection: 'column' }}>
          <Typography variant="h5">Bienestar Mental</Typography>
          <Typography variant="body2">
            Incidencia baja/frecuencia de las síntomas del trauma, afrontamiento positivo, y
...
export default function MentalGrid({ onGridChange, values }: GridProps) {
  ...
  useEffect(() => {
    onGridChange('mental', JSON.stringify(rows));
  }, [rows, onGridChange]);
