    ...
    <GridToolbarContainer>
      ...
      >
        <Box sx={{ display: 'flex', flexDirection: 'column' }}>
          <Typography variant="h5">Salud (Bienestar Físico)</Typography>
          <Typography variant="body2">
            Acceso a la atención médica y motivación del cuidado de la salud personal
          </Typography>
        </Box>
...
export default function PhysicalGrid({ onGridChange, values }: GridProps) {
  ...
  useEffect(() => {
    onGridChange('physical', JSON.stringify(rows.filter((r) => !r.isNew)));
  }, [rows, onGridChange]);
