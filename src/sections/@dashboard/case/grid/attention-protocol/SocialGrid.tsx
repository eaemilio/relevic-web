    ...
    <GridToolbarContainer>
      ...
      >
        <Box sx={{ display: 'flex', flexDirection: 'column' }}>
          <Typography variant="h5">Apoyo Social</Typography>
          <Typography variant="body2">Sentido de conexión/pertenencia y acceso a ayuda</Typography>
        </Box>
...
export default function SocialGrid({ onGridChange, values }: GridProps) {
  ...
  useEffect(() => {
    onGridChange('social', JSON.stringify(rows));
  }, [rows, onGridChange]);
